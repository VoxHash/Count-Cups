...
class DashboardScreen(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        title.setStyleSheet("font-size: 28px; font-weight: bold; color: #ffffff; margin-bottom: 8px;")
        ...
        progress_card = self._create_card("Today's Progress", "Track your daily hydration goal")
        ...
        self.goal_label.setStyleSheet("color: #d0d0d0; font-size: 14px; margin-top: 8px;")
        ...
        self.today_ml_label.setStyleSheet("color: #ffffff; font-size: 24px; font-weight: bold;")
        ...
        self.today_cups_label.setStyleSheet("color: #ffffff; font-size: 24px; font-weight: bold;")
        ...
        self.today_sips_label.setStyleSheet("color: #ffffff; font-size: 24px; font-weight: bold;")
    ...
    def _create_card(self, title: str, subtitle: str) -> QFrame:
        ...
        activity_card = self._create_card("Recent Activity", "Your latest hydration events")
        ...
        self.activity_list.setStyleSheet("color: #d0d0d0; font-size: 14px; padding: 8px;")
    ...
    def refresh_data(self) -> None:
        ...
        try:
            ...
            self.goal_label.setText(f"{daily_stats.progress_percentage:.0f}% of daily goal")
    ...
    def _update_activity_list(self, events) -> None:
        ...
        for event in events[-5:]:  # Show last 5 events
            event_text = f"{event.timestamp.strftime('%H:%M')} - {event.ml_estimate:.0f}ml sip"
            event_label = QLabel(event_text)
            event_label.setStyleSheet("color: #ffffff; font-size: 12px; padding: 4px; background-color: #2a2a2a; border-radius: 4px; margin: 2px;")
