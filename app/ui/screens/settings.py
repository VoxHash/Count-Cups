...
class SettingsScreen(QWidget):
    ...
    def _create_detection_tab(self) -> None:
        ...
        self.detection_engine.currentTextChanged.connect(
    ...
    def _create_advanced_tab(self) -> None:
        ...
        self.enable_telemetry.setToolTip(
    ...
    def _save_settings(self) -> None:
        ...
        try:
            ...
            # Update settings
            from app.core.models import DetectionEngine, ThemeMode

            settings.theme = ThemeMode(self.theme_combo.currentText().lower())
            settings.detection_engine = DetectionEngine(
                self.detection_engine.currentText().lower()
            )
