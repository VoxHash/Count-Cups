...
from PyQt6.QtWidgets import (
    ...
    QStatusBar, QToolBar, QMessageBox, QSystemTrayIcon,
    QMenu, QLabel, QPushButton, QApplication
)
from PyQt6.QtCore import pyqtSignal
from PyQt6.QtGui import QIcon, QKeySequence, QActionGroup, QAction
...
class MainWindow(QMainWindow):
    ...
    def _connect_signals(self) -> None:
        ...
        if hasattr(self, 'live_cam_screen'):
            self.live_cam_screen.camera_status_changed.connect(self._on_camera_status_changed)
            self.live_cam_screen.sip_detected.connect(self._on_sip_detected)
        
        if hasattr(self, 'settings_screen'):
            self.settings_screen.detection_engine_changed.connect(self._on_detection_engine_changed)
    ...
    def _export_daily_stats(self) -> None:
        ...
        QMessageBox.information(self, "Export", "Daily statistics export not yet implemented.")
    
    def _export_sip_events(self) -> None:
        """Export sip events."""
        # This would implement CSV export in a real implementation
        QMessageBox.information(self, "Export", "Sip events export not yet implemented.")
